...
import { FeedbackFormListPage as ShowCaseList } from 'pages/feedback-forms';
...
function DashboardPage() {
  ...
  const feedbackFormStat = useSWR<PaginatedInterface<FeedbackFormInterface>>(
    () => `/feedback-forms`,
    () => getFeedbackForms({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    },
    {
      ...
      result: feedbackFormStat?.data?.totalCount,
      isLoading: feedbackFormStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
    {
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`feedback-forms`} passHref legacyBehavior>
                  <Button
