...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Customer Speak`}</title>

        <meta
          name="description"
          content="Experience Customer Speak - Revolutionizing Customer Feedback with Simple Smileys and Seamless Data Capture for an Unmatched Overview of Customer Satisfaction."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1613963931023-5dc59437c8a6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjdXN0b21lciUyMGZlZWRiYWNrfGVufDB8fHx8MTY5NDAxNzUzNHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Customer Speak - Revolutionizing Customer Feedback with Simple Smileys and Seamless Data Capture for an Unmatched Overview of Customer Satisfaction.`}
            </Text>
            <Box
