  ...
  const fetcher = useCallback(
    async () =>
      getCustomerFeedbacks({
        relations: ['feedback_option'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['customer_name.contains', 'customer_number.contains'],
        ...(params.filters || {}),
      }),
      ...
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Link
              ...
              href={`/feedback-options/view/${record.feedback_option?.id}`}
            >
              {record.feedback_option?.option_text}
            </Link>
          ),
        }
      : null,
