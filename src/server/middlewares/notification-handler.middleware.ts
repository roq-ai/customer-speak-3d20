...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'customer_feedback.create': {
    roles: ['business-owner', 'team-member', 'customer-service-representative', 'data-analyst'],
    key: 'new-feedback-received',
    tenantPath: ['business', 'feedback_form', 'feedback_option', 'customer_feedback'],
    userPath: [],
  },
  'feedback_form.update': {
    roles: ['business-owner', 'team-member', 'customer-service-representative', 'data-analyst'],
    key: 'feedback-form-updated',
    tenantPath: ['business', 'feedback_form'],
    userPath: [],
  },
  'feedback_form.delete': {
    roles: ['business-owner', 'team-member', 'customer-service-representative', 'data-analyst'],
    key: 'feedback-form-deleted',
    tenantPath: ['business', 'feedback_form'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'team-member', 'customer-service-representative', 'data-analyst'];
